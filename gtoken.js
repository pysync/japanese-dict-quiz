...
// Last Edit by _nullptr 2017/04/03
// Fix: use async request
var got = require('got');
...
var now = Math.floor(Date.now() / 3600000);
    if (Number(window.TKK.split('.')[0]) === now) {
        ...
        const res = syncrequest('GET', 'https://translate.google.com');
